...
// Session validation
export const validateSession = async (supabase: any) => {
...
// Request validation
export const validateRequest = (req: NextApiRequest, allowedMethods: string[]) => {
...
export const withSecurity = (
  ...
  return async (req: NextApiRequest, res: NextApiResponse) => {
    try {
      ...
      validateRequest(req, allowedMethods);
